...
--rpc-port 8845 \
--force-authoring \
--node-key-file ./data/chains/<YOUR_PARACHAIN_ID>/network/secret_ed25519 \
-- \
--sync warp \
--chain paseo \
--port 50343 \
